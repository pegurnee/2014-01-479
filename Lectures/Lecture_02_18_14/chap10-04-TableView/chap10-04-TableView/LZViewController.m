...
//    myTableData  = [[NSArray alloc] initWithObjects:@"Bell", @"Letter", @"Tree", @"Present", @"Hat", @"Snowman", nil];
    myImageData  = [[NSArray alloc] initWithObjects:@"christmas_decorations", @"christmas_letter", @"christmas_tree", @"present", @"santa_hat",
                    @"snowman", nil];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *msg = [[NSString alloc] initWithFormat:@"You've selected %@", [myTableData objectAtIndex:indexPath.row]];
